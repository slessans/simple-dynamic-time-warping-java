...
public class Problem7 {
    ...
    public Problem7(String testingPath, String trainingPath) {
    ...
    public String run(final int digit, final int variant) throws IOException, InvalidFeatureVectorListFileException {
        ...
        for(DataFactory.DataType dataType : DataFactory.DataType.values()) {
            this.featureVectors.put(dataType, dataFactory.readTrainingFeatures(digit, variant, dataType));
        }
    ...
    public static void main(String [] args) throws Exception {
        ...
        Problem7 p7 = new Problem7(testingPath, trainingPath);
        ...
        for(TrainingInput input : inputs) {
            results.add(p7.run(input.digit, input.variant));
        }
